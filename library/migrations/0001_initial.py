        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "creator",
                    models.CharField(
                        help_text="Enter the creator of the game", max_length=200
                    ),
                ),
                (
                    "platforms",
                ...
                (
                    "release_date",
                    models.DateField(help_text="Enter the release date of the game"),
                ),
                ("is_free", models.BooleanField(help_text="Is the game free?")),
                (
                    "num_players",
                    models.IntegerField(help_text="Enter the number of players"),
                ),
                (
                    "global_rating",
                    models.DecimalField(
                ...
                (
                    "is_multiplayer",
                    models.BooleanField(help_text="Is the game multiplayer?"),
                ),
                (
                    "genere",
                    models.CharField(
                        help_text="Enter the genere of the game", max_length=50
                    ),
                ),
                (
                    "description",
                    models.TextField(help_text="Enter the description of the game"),
                ),
